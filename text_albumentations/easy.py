...
def _build_task_registry() -> dict[str, BaseSingleChunkAugmentation]:
    ...
    return {
        ...
        "claim_evidence_plan": tasks.claim_evidence_augmentation,
        ...
        "sentence_equivalence_plan": tasks.sentence_equivalence_augmentation,
        "sentence_contrast_plan": tasks.sentence_contrast_augmentation,
